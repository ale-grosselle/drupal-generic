 ...
 */
function dentist_process_page(&$variables)
{
	// Hook into color.module.
	if (module_exists('color')) {
 ...
 */
function dentist_preprocess_maintenance_page(&$variables)
{
	...
	drupal_add_css(drupal_get_path('theme', 'dentist') . '/css/maintenance-page.css');
}

/**
 * Override or insert variables into the maintenance page template.
 */
function dentist_process_maintenance_page(&$variables)
{
	// Always print the site name and slogan, but if they are toggled off, we'll
	// just hide them visually.
	$variables['hide_site_name'] = theme_get_setting('toggle_name') ? FALSE : TRUE;
 ...
 */
function dentist_preprocess_node(&$variables)
{
 ...
 */
function dentist_menu_tree($variables)
{
 ...
 */
function dentist_field__taxonomy_term_reference($variables)
{
	$output = '';
...
function dentist_links__system_main_menu($variables){
...
function dentist_menu_breadcrumb_alter(&$active_trail, $item) {
...
function dentist_form_alter(&$variables) {
