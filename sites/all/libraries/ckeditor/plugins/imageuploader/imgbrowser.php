...
$path = base_path() . "sites/all/libraries/ckeditor/plugins/imageuploader/imgupload.php";
...
<div id="uploadImgDiv" class="lightbox popout">
    ...
    <form action="<?php print $path; ?>" method="post" enctype="multipart/form-data" id="uploadImgForm" onsubmit="return checkUpload();">
